...
namespace Server.Mobiles
{
    ...
    {
        private int m_Pay = 10;
        private bool m_IsHired;
        private bool m_IsInArmy;
        private ArmyController m_Army;
        ...
        public override void Serialize(GenericWriter writer)
        {
            ...
            writer.Write((bool)m_IsInArmy);     //version 1
            writer.Write((ArmyController)m_Army);

            writer.Write((bool)m_IsHired);      //version 0
        ...
        public virtual Mobile GetOwner()
        {
            ...
            if (Owner.Deleted || ((!IsInArmy) && (Owner.Map != this.Map || !Owner.InRange(Location, 30))))
            {
