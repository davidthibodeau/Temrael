...
{
	[CorpseName( "Corps de Scarabée Géant" )]
	public class Scarabee : BaseMount
	{
		...
		[Constructable]
		public Scarabee( string name ) : base( name, 0xF0, 0x3EAB, AIType.AI_Melee, FightMode.Closest, 10, 1, 0.25, 0.5 )
		{
			SetStr( 300 );
			SetDex( 100 );
			SetInt( 500 );
