...
namespace Server.Mobiles
{
	public class Tailor : BaseVendor
	{
		...
		{
			SetSkill( SkillName.Couture, 64.0, 100.0 );
		}
		...
		public override void InitSBInfo()
		{
            ...
            switch (races)
            {
                ...
                case Races.Humain: m_SBInfos.Add(new SBTailor()); break;
		...
		/*public override Item CreateBulkOrder( Mobile from, bool fromContextMenu )
		{
			...
			{
				double theirSkill = pm.Skills[SkillName.Couture].Base;
		...
		{
			return ( from is PlayerMobile && from.Skills[SkillName.Couture].Base > 0 );
		}
