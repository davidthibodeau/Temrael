...
namespace Server.Mobiles
{
	public class ThiefGuildmaster : BaseGuildmaster
	{
		...
		{
			SetSkill( SkillName.Detection, 75.0, 98.0 );
			SetSkill( SkillName.Discretion, 65.0, 88.0 );
			SetSkill( SkillName.Crochetage, 85.0, 100.0 );
			SetSkill( SkillName.Fouille, 90.0, 100.0 );
			SetSkill( SkillName.Empoisonner, 60.0, 83.0 );
			SetSkill( SkillName.Vol, 90.0, 100.0 );
			SetSkill( SkillName.ArmePerforante, 75.0, 98.0 );
			SetSkill( SkillName.Infiltration, 85.0, 100.0 );
		...
		public override bool CheckCustomReqs( PlayerMobile pm )
		{
			...
			else if ( pm.Skills[SkillName.Vol].Base < 60.0 )
			{
