	...
	public class SBTavernKeeper : SBInfo
	{
		...
		public class InternalBuyInfo : List<GenericBuyInfo>
		{
			public InternalBuyInfo()
			{
				...
				Add( new BeverageBuyInfo( typeof( Pitcher ), BeverageType.Milk, 3, 20, 0x9F0, 0 ) );
				...
				Add( new GenericBuyInfo( typeof( BreadLoaf ), 4, 10, 0x103B, 0 ) );
				Add( new GenericBuyInfo( typeof( CheeseWheel ), 5, 10, 0x97E, 0 ) );
				Add( new GenericBuyInfo( typeof( CookedBird ), 3, 20, 0x9B7, 0 ) );
                ...
                Add(new GenericBuyInfo("1041243", typeof(ContractOfEmployment), 2500, 20, 0x14F0, 0));
                /*Add(new GenericBuyInfo("a barkeep contract", typeof(BarkeepContract), 2500, 20, 0x14F0, 0));*/
