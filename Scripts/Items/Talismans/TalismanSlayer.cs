	...
	public static class TalismanSlayer
	{
		...
		public static void Initialize()
		{
			...
			m_Table[ TalismanSlayerName.Vermin ] = new Type[]
			{
				...
				typeof( Ratman ), typeof( Rat ), typeof( GiantRat ) //, typeof( Chiikkaha )
			};
			...
			m_Table[ TalismanSlayerName.Scarabee ] = new Type[]
			{
				typeof( Scarabee ), typeof( RuneScarabee ), typeof( FireScarabee ), typeof( DeathwatchScarabee ),
				typeof( DeathwatchScarabeeHatchling )
			};

			m_Table[ TalismanSlayerName.Bird ] = new Type[]
			{
				typeof( Bird ), typeof( TropicalBird ), typeof( Chicken ), typeof( Crane ),
				typeof( DinosaureDesert ), typeof( Eagle ), typeof( DinosaureForet ), typeof( DinosaureVolcan ),
				/*typeof( Pyre ), typeof( Swoop ), typeof( Saliva ),*/ typeof( Harpy ),
				typeof( StoneHarpy ) // ?????
			};
			...
			{
				//typeof( FireScarabee ), typeof( HellHound ), typeof( LavaSerpent ), typeof( FireElemental ),
			...
			{
				typeof( Cow ), typeof( Bull ) /*, typeof( MinotaurCaptain ),
