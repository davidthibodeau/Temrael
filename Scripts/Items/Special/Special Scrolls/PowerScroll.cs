...
namespace Server.Items
{
	public class PowerScroll : SpecialScroll
	{
		...
		public static PowerScroll CreateRandomNoCraft( int min, int max )
		{
			...
			} while ( skillName == SkillName.Forge || skillName == SkillName.Couture );

			return new PowerScroll( skillName, 100 + (Utility.RandomMinMax( min, max ) * 5));
		}

		public PowerScroll() : this( SkillName.Alchimie, 0.0 )
		{
		}
		...
		public PowerScroll( SkillName skill, double value ) : base( skill, value )
		{
            ...
            if (Value == 105.0 || skill == Server.SkillName.Forge || skill == Server.SkillName.Couture )
		...
		public override void Deserialize( GenericReader reader )
		{
            ...
            if (Value == 105.0 || Skill == SkillName.Forge || Skill == SkillName.Couture)
			{
				LootType = LootType.Regular;
			}
			else
