	...
	public abstract class BaseGlovesOfMining : BaseArmor
	{
		...
		public int Bonus
		{
			...
			set
			{
				...
				{
					m_SkillMod = new DefaultSkillMod( SkillName.Excavation, true, m_Bonus );
		...
		public BaseGlovesOfMining( int bonus, int itemID ) : base( itemID )
		{
			...
			this.Hue = CraftResources.GetHue( (CraftResource)Utility.RandomMinMax( (int)CraftResource.Cuivre, (int)CraftResource.Umbrarium ) );
		}
