...
namespace Server.Items
{
	...
	public class ShepherdsCrook : BaseStaff
	{
		...
		public override int DefStrengthReq{ get{ return 20; } }
		...
		private class HerdingTarget : Target
		{
			...
			private static Type[] m_ChampTamables = new Type[]
			{
				...
				typeof( Snake ), typeof( Drake ), typeof( Dragon ),
				typeof( Kirin ), typeof( Licorne ), typeof( GiantRat ), typeof( Slime ),
				typeof( DireWolf ), typeof( HellHound ), typeof( DeathwatchScarabee ), 
				typeof( Griffon )
			};
