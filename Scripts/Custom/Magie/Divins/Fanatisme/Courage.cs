...
{
    public class CourageSpell : ReligiousSpell
    {
        public static Hashtable m_CourageTable = new Hashtable();
        ...
        public void Target(Mobile m)
        {
            ...
            else if (CheckSequence())
            {
                ...
                m_CourageTable[m] = (int)(5 + (Caster.Skills[CastSkill].Value + Caster.Skills[DamageSkill].Value) / 20);
        ...
        {
            private CourageSpell m_Owner;

            public InternalTarget(CourageSpell owner)
