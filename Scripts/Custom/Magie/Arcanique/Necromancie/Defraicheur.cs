	...
	public class DefraicheurSpell : Spell
	{
		...
		public void Target( IPoint3D p )
		{
			...
			else if ( CheckSequence() )
			{
				...
				if ( map != null )
				{
                    IPooledEnumerable eable = map.GetMobilesInRange(new Point3D(p), (int)SpellHelper.AdjustValue(Caster, 2 + Caster.Skills[CastSkill].Value / 15, NAptitude.Sorcellerie, true));
