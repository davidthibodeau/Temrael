...
namespace Server.Gumps
{
    ...
    public class NewSpellbookGump : Gump
    {
        public static SpellBookEntry[] m_SpellBookEntry = new SpellBookEntry[]
        {
            ...
            new SpellBookEntry( 5, Aptitude.Illusion, "Rappel", new Type[] { typeof(BlackPearl), typeof(Bloodmoss), typeof(MandrakeRoot) }, 0x8DF, 4, 32),
            ...
            new SpellBookEntry( 7, Aptitude.Illusion, "Marque", new Type[] { typeof(BlackPearl), typeof(Bloodmoss), typeof(MandrakeRoot) }, 0x8EC, 6, 45),
            ...
            new SpellBookEntry( 2, Aptitude.Necromancie, "Corruption", new Type[] { typeof(GraveDust), typeof(PigIron) }, 0x5008, 9, 108),
            new SpellBookEntry( 2, Aptitude.Necromancie, "Présage", new Type[] { typeof(BatWing), typeof(NoxCrystal) }, 0x5004, 9, 104),
            new SpellBookEntry( 3, Aptitude.Necromancie, "Sermant", new Type[] { typeof(DaemonBlood) }, 0x5001, 9, 101),
            ...
            new SpellBookEntry( 5, Aptitude.Necromancie, "Bête Horrifique", new Type[] { typeof(BatWing), typeof(DaemonBlood) }, 0x5005, 9, 105),
            new SpellBookEntry( 6, Aptitude.Necromancie, "Venin", new Type[] { typeof(NoxCrystal) }, 0x5009, 9, 109),
            new SpellBookEntry( 7, Aptitude.Necromancie, "Flétrir", new Type[] { typeof(NoxCrystal), typeof(GraveDust), typeof(PigIron) }, 0x500E, 9, 114),
            new SpellBookEntry( 8, Aptitude.Necromancie, "Étranglement", new Type[] { typeof(DaemonBlood), typeof(NoxCrystal) }, 0x500A, 9, 110),
            new SpellBookEntry( 9, Aptitude.Necromancie, "Liche", new Type[] { typeof(GraveDust), typeof(DaemonBlood), typeof(NoxCrystal) }, 0x5006, 9, 106),
            new SpellBookEntry( 10, Aptitude.Necromancie, "Maudire", new Type[] { typeof(PigIron) }, 0x5003, 9, 103),
