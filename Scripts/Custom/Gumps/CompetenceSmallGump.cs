...
namespace Server.Gumps
{
    class CompetenceSmallGump : Gump
    {
        ...
        private Server.Gumps.CompetenceGump.CompDomaines m_Tab;
        private bool m_ShowCaps;

        public CompetenceSmallGump(TMobile from, Server.Gumps.CompetenceGump.CompDomaines tab, bool showCaps)
            : base(0, 0)
        {
            m_From = from;
            m_Tab = tab;
