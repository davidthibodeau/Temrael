...
namespace Server.Engines.Craft
{
	public class DefTailoring : CraftSystem
	{
		...
		public override void InitCraftList()
		{
            ...
            index = AddCraft(typeof(TurbanVoile), "Chapeaux", "Turban Voilé", 50.0, 60.0, typeof(Cloth), "Coton", 6, 1044287);
            ...
            index = AddCraft(typeof(WideBrimHat), "Chapeaux", "Chapeau à large bord", 10.0, 30.0, typeof(Cloth), "Coton", 12, 1044287);
            ...
            //index = AddCraft( typeof( WizardsHat ), "Chapeaux", "Béret", 7.2, 32.2, typeof( Cloth ), "Coton", 15, 1044287 );
            index = AddCraft(typeof(Bonnet), "Chapeaux", "Bonnet", 30.0, 50.0, typeof(Cloth), "Coton", 11, 1044287);
            index = AddCraft(typeof(FeatheredHat), "Chapeaux", "Chapeau à plume", 40.0, 60.0, typeof(Cloth), "Coton", 12, 1044287);
            ...
            index = AddCraft(typeof(ChapeauNoble), "Chapeaux", "Béret", 80.0, 90.0, typeof(Cloth), "Coton", 6, 1044287);
            index = AddCraft(typeof(ChapeauLoup), "Chapeaux", "Tête de Loup", 60.0, 80.0, typeof(Leather), "Cuir", 6, 1044287);
			...
			#region Coussins
			index = AddCraft(typeof(CoussinB), "Coussins", "Petit coussin carré", 20.0, 40.0, typeof(Cloth), "Coton", 3, 1044287);
			...
			AddRes(index, typeof(Feather), "Plumes", 5, 1044563);
			index = AddCraft(typeof(CoussinD), "Coussins", "Gros oreiller carré", 50.0, 70.0, typeof(Cloth), "Coton", 4, 1044287);
			AddRes(index, typeof(Feather), "Plumes", 5, 1044563);
			...
			AddRes(index, typeof(Feather), "Plumes", 5, 1044563);
			index = AddCraft(typeof(CoussinG), "Coussins", "Petit coussin carré à pompon", 30.0, 50.0, typeof(Cloth), "Coton", 3, 1044287);
			AddRes(index, typeof(Feather), "Plumes", 5, 1044563);
			index = AddCraft(typeof(CoussinH), "Coussins", "Autre petit coussin carré à pompon", 30.0, 50.0, typeof(Cloth), "Coton", 3, 1044287);
			AddRes(index, typeof(Feather), "Plumes", 5, 1044563);
			index = AddCraft(typeof(CoussinI), "Coussins", "Gros coussin carré", 40.0, 60.0, typeof(Cloth), "Coton", 3, 1044287);
			AddRes(index, typeof(Feather), "Plumes", 5, 1044563);
			index = AddCraft(typeof(CoussinJ), "Coussins", "Gros coussin carré droit", 0.0, 60.0, typeof(Cloth), "Coton", 3, 1044287);
			AddRes(index, typeof(Feather), "Plumes", 5, 1044563);
            #endregion
            ...
            index = AddCraft(typeof(TogePelerin), "Toges & Manteaux", "Toge Pèlerine", 30.0, 50.0, typeof(Cloth), "Coton", 17, 1044287);
            ...
            index = AddCraft(typeof(TogeDecore), "Toges & Manteaux", "Toge Décorée", 50.0, 70.0, typeof(Cloth), "Coton", 17, 1044287);
            ...
            index = AddCraft(typeof(TogeFeminine), "Toges & Manteaux", "Toge de Prêtrise", 90.0, 110.0, typeof(Cloth), "Coton", 17, 1044287);
            ...
            index = AddCraft(typeof(ManteauRaye), "Toges & Manteaux", "Manteau Rayé", 80.0, 100.0, typeof(Cloth), "Coton", 14, 1044287);
            ...
            index = AddCraft(typeof(CapeEtendard), "Capes", "Cape Étendard", 40.0, 70.0, typeof(Cloth), "Coton", 14, 1044287);
            index = AddCraft(typeof(CapeCapuche), "Capes", "Cape à Capuche", 40.0, 70.0, typeof(Cloth), "Coton", 15, 1044287);
            index = AddCraft(typeof(CapeCol), "Capes", "Cape à Col", 40.0, 70.0, typeof(Cloth), "Coton", 15, 1044287);
            index = AddCraft(typeof(CapeColLong), "Capes", "Cape à Long Col", 50.0, 80.0, typeof(Cloth), "Coton", 16, 1044287);
            index = AddCraft(typeof(CapeSolide), "Capes", "Cape Solide", 50.0, 80.0, typeof(Cloth), "Coton", 14, 1044287);
            index = AddCraft(typeof(CapeEpauliere), "Capes", "Cape à Épaulières", 50.0, 80.0, typeof(Cloth), "Coton", 14, 1044287);
            index = AddCraft(typeof(CapeDecore), "Capes", "Cape Décorée", 50.0, 80.0, typeof(Cloth), "Coton", 14, 1044287);
            index = AddCraft(typeof(CapeLongue), "Capes", "Cape Longue", 60.0, 90.0, typeof(Cloth), "Coton", 14, 1044287);
            index = AddCraft(typeof(CapeTrainee), "Capes", "Cape à Trainée", 60.0, 90.0, typeof(Cloth), "Coton", 17, 1044287);
            index = AddCraft(typeof(CapeCagoule), "Capes", "Cape à Cagoule", 60.0, 90.0, typeof(Cloth), "Coton", 15, 1044287);
            ...
            index = AddCraft(typeof(CapeFeminine), "Capes", "Cape Féminine", 70.0, 100.0, typeof(Cloth), "Coton", 13, 1044287);
            ...
            index = AddCraft(typeof(CapePlume), "Capes", "Cape à Plumes", 90.0, 120.0, typeof(Feather), "Plumes", 60, 1044287);
            index = AddCraft(typeof(CapeSombre), "Capes", "Cape Sombre", 90.0, 120.0, typeof(Cloth), "Coton", 60, 1044287);

            #endregion

            #region Robes
            index = AddCraft(typeof(RobeDechire), "Robes", "Robe déchirée", 0.0, 5.0, typeof(Cloth), "Coton", 6, 1044287);
            ...
            index = AddCraft(typeof(RobeBohemienne), "Robes", "Robe Bohémienne", 25.0, 55.0, typeof(Cloth), "Coton", 10, 1044287);
            ...
            index = AddCraft(typeof(RobeOrne), "Robes", "Robe Orné", 40.0, 70.0, typeof(Cloth), "Coton", 11, 1044287);
            index = AddCraft(typeof(RobeAmusante), "Robes", "Robe Amusante", 45.0, 75.0, typeof(Cloth), "Coton", 12, 1044287);
            index = AddCraft(typeof(RobeElegante), "Robes", "Robe Élégante", 45.0, 75.0, typeof(Cloth), "Coton", 12, 1044287);
            index = AddCraft(typeof(RobeSeduisante), "Robes", "Robe Séduisante", 45.0, 75.0, typeof(Cloth), "Coton", 12, 1044287);
            ...
            index = AddCraft(typeof(RobeACorset), "Robes", "Robe À Corset", 60.0, 90.0, typeof(Cloth), "Coton", 14, 1044287);
            index = AddCraft(typeof(RobeCorsetAmple), "Robes", "Robe À Corset Ample", 60.0, 90.0, typeof(Cloth), "Coton", 16, 1044287);
            ...
            index = AddCraft(typeof(RobeDore), "Robes", "Robe Doré", 70.0, 100.0, typeof(Cloth), "Coton", 14, 1044287);
            ...
            index = AddCraft(typeof(RobeAraneide), "Robes", "Robe Aranéide", 75.0, 105.0, typeof(Cloth), "Coton", 12, 1044287);
            ...
            index = AddCraft(typeof(RobeAraignee), "Robes", "Robe Araignée", 80.0, 110.0, typeof(Cloth), "Coton", 8, 1044287);
            index = AddCraft(typeof(RobeAntique), "Robes", "Robe Antique", 80.0, 110.0, typeof(Cloth), "Coton", 10, 1044287);
            index = AddCraft(typeof(FancyDress), "Robes", "Robe Décoré", 80.0, 110.0, typeof(Cloth), "Coton", 12, 1044287);
            ...
            index = AddCraft(typeof(RobeJuponElfique), "Robes", "Robe à Jupon Elfique", 90.0, 120.0, typeof(Cloth), "Coton", 12, 1044287);
            ...
            index = AddCraft(typeof(RobeBoheme), "Robes", "Robe Bohème", 95.0, 125.0, typeof(Cloth), "Coton", 6, 1044287);
            index = AddCraft(typeof(RobeDentelle), "Robes", "Robe avec Dentelle", 95.0, 125.0, typeof(Cloth), "Coton", 16, 1044287);
            index = AddCraft(typeof(RobeTrainee), "Robes", "Robe avec Trainée", 95.0, 125.0, typeof(Cloth), "Coton", 16, 1044287);
            index = AddCraft(typeof(RobeMariage), "Robes", "Robe de Mariage", 95.0, 125.0, typeof(Cloth), "Coton", 16, 1044287);
            #endregion

            #region Shirts
            index = AddCraft(typeof(ChandailCourtDechire), "Tuniques & Chemises", "Chandail Déchiré", 0.0, 10.0, typeof(Cloth), "Coton", 9, 1044287);
            index = AddCraft(typeof(ChandailDechire), "Tuniques & Chemises", "Chemise Déchiré", 0.0, 10.0, typeof(Cloth), "Coton", 9, 1044287);
            index = AddCraft(typeof(ChandailLongDechire), "Tuniques & Chemises", "Chandail Long Déchiré", 0.0, 10.0, typeof(Cloth), "Coton", 9, 1044287);
            index = AddCraft(typeof(TuniqueDechire), "Tuniques & Chemises", "Tunique Déchirée", 0.0, 10.0, typeof(Cloth), "Coton", 10, 1044287);
            index = AddCraft(typeof(TuniqueLongueDechire), "Tuniques & Chemises", "Tunique Longue Déchirée", 0.0, 10.0, typeof(Cloth), "Coton", 12, 1044287);
            index = AddCraft(typeof(TabarDechire), "Tuniques & Chemises", "Tabar Déchiré", 0.0, 10.0, typeof(Cloth), "Coton", 10, 1044287);
            ...
            index = AddCraft(typeof(FancyShirt), "Tuniques & Chemises", "Chandail à manches longues", 40.0, 70.0, typeof(Cloth), "Coton", 8, 1044287);
            index = AddCraft(typeof(ChandailBordel), "Tuniques & Chemises", "Chandail de Bordel", 50.0, 80.0, typeof(Cloth), "Coton", 8, 1044287);
            index = AddCraft(typeof(ChandailDecore), "Tuniques & Chemises", "Chandail Decoré", 60.0, 90.0, typeof(Cloth), "Coton", 8, 1044287);
            ...
            index = AddCraft(typeof(ChandailFeminin), "Tuniques & Chemises", "Chandail Féminin", 80.0, 110.0, typeof(Cloth), "Coton", 8, 1044287);
            ...
            index = AddCraft(typeof(ChemiseCol), "Tuniques & Chemises", "Chemise à Col", 30.0, 50.0, typeof(Cloth), "Coton", 8, 1044287);
            index = AddCraft(typeof(ChemiseReligieuse), "Tuniques & Chemises", "Chemise Religieuse", 40.0, 70.0, typeof(Cloth), "Coton", 8, 1044287);
            index = AddCraft(typeof(Chemiselacee), "Tuniques & Chemises", "Chemise Lacée", 40.0, 70.0, typeof(Cloth), "Coton", 8, 1044287);
            index = AddCraft(typeof(ChemiseBourgeoise), "Tuniques & Chemises", "Chemise Bourgeoise", 50.0, 80.0, typeof(Cloth), "Coton", 8, 1044287);
            index = AddCraft(typeof(ChemiseGaine), "Tuniques & Chemises", "Chemise à Gaine", 60.0, 90.0, typeof(Cloth), "Coton", 10, 1044287);
            index = AddCraft(typeof(ChemiseLongue), "Tuniques & Chemises", "Chemise à manches longues", 70.0, 100.0, typeof(Cloth), "Coton", 11, 1044287);
            ...
            index = AddCraft(typeof(DoubletBouton), "Tuniques & Chemises", "Doublet à Boutons", 50.0, 70.0, typeof(Cloth), "Coton", 8, 1044287);
            ...
            index = AddCraft(typeof(DoubletArmure), "Tuniques & Chemises", "Doublet Armuré", 80.0, 110.0, typeof(Cloth), "Coton", 9, 1044287);
			...
			#region Pants
            index = AddCraft(typeof(PantalonsDechires), "Pantalons & Jupes", "Pantalons Déchirés", 0.0, 10.0, typeof(Cloth), "Coton", 5, 1044287);
            ...
            index = AddCraft(typeof(PantalonsArmure), "Pantalons & Jupes", "Pantalons Armuré", 90.0, 120.0, typeof(Leather), "Cuir", 9, 1044287);
            ...
            index = AddCraft(typeof(JupeOuvrier), "Pantalons & Jupes", "Jupe Dechiré", 0.0, 10.0, typeof(Cloth), "Coton", 3, 1044287);
            ...
            index = AddCraft(typeof(JupeDecore), "Pantalons & Jupes", "Jupe Decoré", 50.0, 80.0, typeof(Cloth), "Coton", 8, 1044287);
            ...
            index = AddCraft(typeof(Jartelles), "Accessoires", "Jartelles Complètes", 40.0, 60.0, typeof(Cloth), "Coton", 14, 1044287);
            ...
            index = AddCraft(typeof(CeintureBoucle), "Accessoires", "Ceinture Bouclé", 30.0, 50.0, typeof(Leather), "Cuir", 4, 1044287);
            ...
            index = AddCraft(typeof(FourreauDague), "Accessoires", "Fourreau à Dague", 40.0, 70.0, typeof(Leather), "Cuir", 5, 1044287);
            index = AddCraft(typeof(FourreauDecouvert), "Accessoires", "Fourreau à Découvert", 50.0, 80.0, typeof(Leather), "Cuir", 5, 1044287);
            index = AddCraft(typeof(FourreauRapiere), "Accessoires", "Fourreau d'Estoc", 60.0, 90.0, typeof(Leather), "Cuir", 5, 1044287);
            index = AddCraft(typeof(FourreauEpee), "Accessoires", "Fourreau à Épées", 60.0, 90.0, typeof(Leather), "Cuir", 5, 1044287);
            index = AddCraft(typeof(FourreauSabre), "Accessoires", "Fourreau à Sabres", 70.0, 100.0, typeof(Leather), "Cuir", 5, 1044287);
            ...
            index = AddCraft(typeof(EpauliereBarbare), "Accessoires", "Épaulière Barbare", 60.0, 80.0, typeof(Leather), "Cuir", 8, 1044287);
