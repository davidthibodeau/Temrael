...
namespace Server.Items
{
    public abstract class BaseRawFishSteak : CookableFood
    {
		...
		[Constructable]
        public BaseRawFishSteak(CraftResource resource, int amount) : base(0x097A) //Utility.Random(0x09CC, 4)
		{
			Stackable = true;
			Weight = 0.1;
            Amount = amount;
