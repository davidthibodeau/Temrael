...
namespace Server.Misc
{
	public class CharacterCreation
	{
        ...
        public static void Init(TMobile from)
        {
		...
		private static void FillBankAOS( Mobile m )
		{
			...
			PlaceItemIn( cont, 45, 132, new EtherealLicorne() );
			PlaceItemIn( cont, 69, 66, new EtherealRidgeback() );
			PlaceItemIn( cont, 93, 82, new EtherealDragonMarais() );
			PlaceItemIn( cont, 117, 99, new EtherealScarabee() );
		...
		private static void SetSkills( Mobile m, SkillNameValue[] skills, int prof )
		{
			...
			//				new SkillNameValue( SkillName.Soins, 45 ),
			//				new SkillNameValue( SkillName.ArmeTranchante, 35 ),
			//				new SkillNameValue( SkillName.Tactiques, 50 )
			//			};
            //
			//		break;
			//	}
			...
			//				new SkillNameValue( SkillName.ArmePoing, 30 ),
			//				new SkillNameValue( SkillName.ArtMagique, 50 ),
			//				new SkillNameValue( SkillName.Concentration, 50 )
			//			};
            //
			//		break;
			//	}
			...
			//		skills = new SkillNameValue[]
			//			{
			//				new SkillNameValue( SkillName.Excavation, 30 ),
			//				new SkillNameValue( SkillName.ArmsLore, 30 ),
			//				new SkillNameValue( SkillName.Forge, 50 ),
			//				new SkillNameValue( SkillName.Bricolage, 50 )
			//			};
            //
			//		break;
			//	}
			...
			//		skills = new SkillNameValue[]
			//			{
			//				new SkillNameValue( SkillName.Goetie, 50 ),
			//				new SkillNameValue( SkillName.Focus, 30 ),
			//				new SkillNameValue( SkillName.SpiritSpeak, 30 ),
			//				new SkillNameValue( SkillName.ArmeTranchante, 30 ),
			//				new SkillNameValue( SkillName.Tactiques, 20 )
			//			};
            //
			//		break;
			//	}
			...
			//		skills = new SkillNameValue[]
			//			{
			//				new SkillNameValue( SkillName.Miracles, 51 ),
			//				new SkillNameValue( SkillName.ArmeTranchante, 49 ),
			//				new SkillNameValue( SkillName.Focus, 30 ),
			//				new SkillNameValue( SkillName.Tactiques, 30 )
			//			};
            //
			//		break;
			//	}
			...
			//				new SkillNameValue( SkillName.ArmeTranchante, 50 ),
			//				new SkillNameValue( SkillName.Anatomy, 30 ),
			//				new SkillNameValue( SkillName.Soins, 30 )
			//		};
			//		break;
			//	}
			//	case 7:	//Ninja
			...
			//				new SkillNameValue( SkillName.Discretion, 50 ),
			//				new SkillNameValue( SkillName.ArmePerforante, 30 ),
			//				new SkillNameValue( SkillName.Infiltration, 30 )
			//			};
			//		break;
			//	}
			//	default:
			...
			for ( int i = 0; i < skills.Length; ++i )
			{
				...
				if ( snv.Value > 0 && ( snv.Name != SkillName.Infiltration || prof == 7 ) && snv.Name != SkillName.Pieges )
				{
		...
		private static void	AddSkillItems( SkillName skill, Mobile m )
		{
			...
			switch ( skill )
			{
				...
				case SkillName.Survie:
				{
					PackItem( new Bedroll() );
					PackItem( new Kindling( 5 ) );
					break;
				}
				case SkillName.Menuiserie:
				{
				...
				case SkillName.Soins:
				{
					PackItem( new Bandage( 50 ) );
					PackItem( new Scissors() );
					break;
				}
				case SkillName.Elevage:
				{
					if ( elf )
						EquipItem( new WildStaff() );
					else
				...
				case SkillName.Discretion:
				{
					EquipItem( new Cloak( 0x455 ) );
					break;
				}
				case SkillName.Inscription:
				{
					PackItem( new BlankScroll( 2 ) );
					PackItem( new BlueBook() );
					break;
				}
				case SkillName.Identification:
				{
					if ( elf )
						EquipItem( new WildStaff() );
					else
				...
				case SkillName.Crochetage:
				{
					PackItem( new Lockpick( 20 ) );
					break;
				}
				case SkillName.Foresterie:
				{
					EquipItem( new Hatchet() );
					break;
				}
				case SkillName.ArmeContondante:
				{
					if ( elf )
				...
				case SkillName.Excavation:
				{
					PackItem( new Pickaxe() );
					break;
				}
				case SkillName.Musique:
				{
					PackInstrument();
					break;
				}
				case SkillName.Goetie:
				{
					if( Core.ML )
					{
						Container regs = new BagOfNecroReagents( 50 );
				...
				case SkillName.Couture:
				{
					PackItem( new BoltOfCloth() );
					PackItem( new SewingKit() );
					break;
				}
				case SkillName.Poursuite:
				{
					if ( m_Mobile != null )
					{
