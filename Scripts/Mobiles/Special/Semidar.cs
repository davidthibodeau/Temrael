...
namespace Server.Mobiles
{
	public class Semidar : BaseChampion
	{
		...
		public override Type[] SharedList { get { return new Type[] { typeof(ANecromancerShroud), typeof(LieutenantOfTheBritannianRoyalGuard) }; } }
		...
		public Semidar() : base( AIType.AI_Mage )
		{
			...
			SetSkill( SkillName.Concentration, 120.2, 140.0 );
			SetSkill( SkillName.Tactiques, 90.1, 105.0 );
			SetSkill( SkillName.Anatomie, 90.1, 105.0 );
