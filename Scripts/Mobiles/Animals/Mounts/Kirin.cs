...
namespace Server.Mobiles
{
	...
	public class Kirin : BaseMount
	{
		...
		public override bool DoMountAbility( int damage, Mobile attacker )
		{
			...
			{
                Effects.SendBoltEffect(attacker, true, 0);
                ...
                Effects.SendTargetParticles(Rider, 0, 0, 0, 0x13A7, EffectLayer.Waist);
		...
		public Kirin( string name ) : base( name, 132, 0x3EAD, AIType.AI_Mage, FightMode.Evil, 10, 1, 0.2, 0.4 )
		{
			...
			SetDamageType( ResistanceType.Magical, 10 );

			SetResistance( ResistanceType.Physical, 55, 65 );
			SetResistance( ResistanceType.Magical, 25, 35 );
