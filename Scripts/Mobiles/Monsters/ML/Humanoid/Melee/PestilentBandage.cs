...
namespace Server.Mobiles
{
	...
	public class PestilentBandage : BaseCreature
	{
		...
		public PestilentBandage() : base( AIType.AI_Melee, FightMode.Closest, 10, 1, 0.2, 0.4 ) // NEED TO CHECK
		{
			...
			SetSkill( SkillName.Empoisonnement, 0.0, 10.0 );
			//SetSkill( SkillName.Anatomy, 0 );
			SetSkill( SkillName.Concentration, 75.0, 80.0 );
			SetSkill( SkillName.Tactiques, 80.0, 85.0 );
			SetSkill( SkillName.Anatomie, 70.0, 75.0 );
