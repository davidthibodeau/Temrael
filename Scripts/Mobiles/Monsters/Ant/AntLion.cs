...
namespace Server.Mobiles
{
	...
	public class AntLion : BaseCreature
	{
		...
		public AntLion() : base( AIType.AI_Melee, FightMode.Closest, 10, 1, 0.2, 0.4 )
		{
			...
			SetResistance( ResistanceType.Magie, 30, 35 );
			...
			{
				case 0: orepile = new CuivreOre(); break;
				case 1: orepile = new BronzeOre(); break;
				case 2: orepile = new AcierOre(); break;
				default: orepile = new ArgentOre(); break;
			}
