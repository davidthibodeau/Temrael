...
namespace Server.Mobiles
{
	...
	public class ChaosDragoon : BaseCreature
	{
		...
		public ChaosDragoon() : base( AIType.AI_Melee, FightMode.Closest, 10, 1, 0.15, 0.4 )
		{
			...
			//SetResistance( ResistanceType.Contondant, 25, 38 );
			//SetResistance( ResistanceType.Tranchant, 25, 38 );
			//SetResistance( ResistanceType.Perforant, 25, 38 );
			//SetResistance( ResistanceType.Magie, 25, 38 );

			SetSkill( SkillName.ArmePerforante, 77.6, 92.5 );
			SetSkill( SkillName.Soins, 60.3, 90.0 );
			SetSkill( SkillName.ArmeContondante, 77.6, 92.5 );
			//SetSkill( SkillName.Anatomy, 77.6, 87.5 );
			SetSkill( SkillName.Concentration, 77.6, 97.5 );
