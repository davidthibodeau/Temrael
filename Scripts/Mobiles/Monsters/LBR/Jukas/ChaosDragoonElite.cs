...
{
	[CorpseName("a chaos dragoon elite")]
	public class ChaosDragoonElite : BaseCreature
	{
			...
			: base(AIType.AI_Mage, FightMode.Closest, 10, 1, 0.15, 0.4)
		{
			...
			SetResistance(ResistanceType.Tranchant, 50);
			...
			{
				case 0: res = CraftResource.Cuivre; break;
				case 1: res = CraftResource.Bronze; break;
				case 2: res = CraftResource.Acier; break;
				case 3: res = CraftResource.Argent; break;
				case 4: res = CraftResource.Or; break;
				case 5: res = CraftResource.Mytheril; break;
				case 6: res = CraftResource.Fer; break;
			}

			DragonMarais mt = new DragonMarais();
			mt.HasBarding = true;
		...
		public override bool OnBeforeDeath()
		{
			...
			if ( mount != null )
			{
				if ( mount is DragonMarais )
					((DragonMarais)mount).HasBarding = false;
		...
		{
			if ( to is Dragon || to is WhiteWyrm || to is DragonMarais || to is Drake || to is Cauchemar || to is Griffon || to is Daemon )
				damage *= 3;
		}
