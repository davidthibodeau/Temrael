...
{
	[CorpseName( "a deathwatchScarabee corpse" )]
	[TypeAlias( "Server.Mobiles.DeathWatchScarabee" )]
	public class DeathwatchScarabee : BaseCreature
	{
		...
		[Constructable]
		public DeathwatchScarabee() : base( AIType.AI_Melee, Core.ML ? FightMode.Aggressor : FightMode.Closest, 10, 1, 0.2, 0.4 ) 
		{
			Name = "a deathwatch Scarabee";
            Body = 400;
			...
			SetResistance( ResistanceType.Perforant, 50, 80 );
		...
		public DeathwatchScarabee( Serial serial ) : base( serial )
		{
		}
