...
namespace Server.Mobiles
{
	...
	public class Oni : BaseCreature
	{
		...
		public Oni() : base( AIType.AI_Mage, FightMode.Closest, 10, 1, 0.2, 0.4 )
		{
			...
			SetResistance( ResistanceType.Perforant, 45, 70 );
			SetResistance( ResistanceType.Magie, 45, 65 );

			//SetSkill( SkillName.EvalInt, 100.1, 125.0 );
			SetSkill( SkillName.ArtMagique, 96.1, 106.0 );
			//SetSkill( SkillName.Anatomy, 85.1, 95.0 );
			SetSkill( SkillName.Concentration, 85.1, 100.0 );
			SetSkill( SkillName.Tactiques, 86.1, 101.0 );
