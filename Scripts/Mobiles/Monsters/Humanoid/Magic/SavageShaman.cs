...
namespace Server.Mobiles
{
	...
	public class SavageShaman : BaseCreature
	{
		...
		public SavageShaman() : base( AIType.AI_Mage, FightMode.Closest, 10, 1, 0.2, 0.4 )
		{
			...
			SetSkill( SkillName.ArmePerforante, 62.5, 85.0 );
			SetSkill( SkillName.ArmeContondante, 62.5, 85.0 );
			SetSkill( SkillName.ArtMagique, 72.5, 95.0 );
			SetSkill( SkillName.Concentration, 77.5, 100.0 );
			SetSkill( SkillName.Concentration, 77.5, 100.0 );
			SetSkill( SkillName.Epee, 62.5, 85.0 );
			...
			if ( list.Count > 0 )
			{
				switch ( Utility.Random( 3 ) )
				{
					case 0: /* greater heal */
					{
						...
						{
							bool isFriendly = ( m is Savage || m is SavageRider || m is SavageShaman || m is ChocoboSauvage );
							...
							int toHeal = (int)(Skills[SkillName.ArtMagique].Value * 0.4);
					...
					case 1: /* lightning */
					{
						foreach ( Mobile m in list )
						{
							...
							if ( Core.AOS )
							{
								int baseDamage = 6 + (int)(Skills[SkillName.ArtMagique].Value / 5.0);
