    ...
    public class CorpsPurSpell : ReligiousSpell
    {
        ...
        public void Target(Mobile m)
        {
            ...
            else if (CheckSequence())
            {
                ...
                Effects.SendTargetParticles(m,14170, 10, 20, 5013, 2042, 0, EffectLayer.Head); //ID, speed, dura, effect, hue, render, layer
                m.PlaySound(493);
            }
        ...
        public class CorpsPurTimer : Timer
        {
            ...
            protected override void OnTick()
            {
                if ((DateTime.Now >= endtime && CorpsPurSpell.m_CorpsPurTable.Contains(m_target)) || m_target == null || m_target.Deleted || !m_target.Alive)
                {
                    ...
                    Effects.SendTargetParticles(m_target,14170, 10, 20, 5013, 2042, 0, EffectLayer.Head); //ID, speed, dura, effect, hue, render, layer
