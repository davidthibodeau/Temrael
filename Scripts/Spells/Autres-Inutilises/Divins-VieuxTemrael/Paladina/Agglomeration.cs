    ...
    public class AgglomerationSpell : ReligiousSpell
    {
        ...
        public void Target(Mobile m)
        {
            ...
            else if (CheckSequence())
            {
                ...
                Effects.SendTargetParticles(m,14170, 10, 15, 5013, 1942, 0, EffectLayer.Head); //ID, speed, dura, effect, hue, render, layer
                m.PlaySound(490);
            }
        ...
        public class AgglomerationTimer : Timer
        {
            ...
            protected override void OnTick()
            {
                if ((DateTime.Now >= endtime && AgglomerationSpell.m_AgglomerationTable.Contains(m_target)) || m_target == null || m_target.Deleted || !m_target.Alive)
                {
                    ...
                    Effects.SendTargetParticles(m_target,14170, 10, 15, 5013, 1942, 0, EffectLayer.Head); //ID, speed, dura, effect, hue, render, layer
