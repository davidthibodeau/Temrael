    ...
    public class AuraDeFatigueSpell : ReligiousSpell
    {
        ...
        public void Target(Mobile m)
        {
            ...
            else if (CheckSequence())
            {
                ...
                Effects.SendTargetParticles(m,14170, 10, 15, 5013, 139, 0, EffectLayer.CenterFeet); //ID, speed, dura, effect, hue, render, layer
                m.PlaySound(507);
            }
        ...
        public class AuraDeFatigueTimer : Timer
        {
            ...
            protected override void OnTick()
            {
                if ((DateTime.Now >= endtime && AuraDeFatigueSpell.m_AuraDeFatigueTable.Contains(m_target)) || m_target == null || m_target.Deleted || !m_target.Alive)
                {
                    ...
                    Effects.SendTargetParticles(m_target,14170, 10, 15, 5013, 139, 0, EffectLayer.CenterFeet); //ID, speed, dura, effect, hue, render, layer
