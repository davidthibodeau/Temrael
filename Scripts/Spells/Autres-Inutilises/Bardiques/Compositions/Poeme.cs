    ...
    public class PoemeSpell : BardeSpell
    {
        ...
        public void StopTimer(Mobile m)
        {
            ...
            if (t != null)
            {
                ...
                Effects.SendTargetParticles(m,14170, 10, 20, 5013, 1945, 0, EffectLayer.Head); //ID, speed, dura, effect, hue, render, layer
                m.PlaySound(483);
            }
        }
        ...
        public class PoemeTimer : Timer
        {
            ...
            protected override void OnTick()
            {
                if ((DateTime.Now >= endtime && PoemeSpell.m_PoemeTable.Contains(m_target)) || m_target == null || m_target.Deleted || !m_target.Alive)
                {
                    ...
                    Effects.SendTargetParticles(m_target,14170, 10, 20, 5013, 1945, 0, EffectLayer.Head); //ID, speed, dura, effect, hue, render, layer
