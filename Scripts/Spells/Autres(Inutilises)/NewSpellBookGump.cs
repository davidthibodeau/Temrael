...
namespace Server.Gumps
{
    ...
    public class NewSpellbookGump : Gump
    {
        public static SpellBookEntry[] m_SpellBookEntry = new SpellBookEntry[]
        {
            ...
            //Evocation
            new SpellBookEntry( MagicArrowSpell.Info.Circle,    MagicArrowSpell.Info.skillForCasting, "Fleche Mag.", MagicArrowSpell.Info.Reagents, 0x8C4,  MagicArrowSpell.m_SpellID),
            ...
            new SpellBookEntry( EnergyFieldSpell.Info.Circle,   EnergyFieldSpell.Info.skillForCasting, "Mur d'Energie", EnergyFieldSpell.Info.Reagents, 0x8F1, EnergyFieldSpell.m_SpellID),
            new SpellBookEntry( EtouffementSpell.Info.Circle,   EtouffementSpell.Info.skillForCasting, "Etouffement", EtouffementSpell.Info.Reagents, 0x8E4, EtouffementSpell.m_SpellID),
            new SpellBookEntry( ParalyzeFieldSpell.Info.Circle, ParalyzeFieldSpell.Info.skillForCasting, "Mur Paralysie", ParalyzeFieldSpell.Info.Reagents, 0x8EE, ParalyzeFieldSpell.m_SpellID),
            ...
            // Alteration
            new SpellBookEntry( MindRotSpell.Info.Circle,       MindRotSpell.Info.skillForCasting, "Pourriture", MindRotSpell.Info.Reagents, 0x5007, MindRotSpell.m_SpellID),
            new SpellBookEntry( CurseWeaponSpell.Info.Circle,   CurseWeaponSpell.Info.skillForCasting, "Arme maudite", CurseWeaponSpell.Info.Reagents, 0x5003, CurseWeaponSpell.m_SpellID),
            new SpellBookEntry( BloodOathSpell.Info.Circle,     BloodOathSpell.Info.skillForCasting, "Pacte de sang", BloodOathSpell.Info.Reagents, 0x5001, BloodOathSpell.m_SpellID),
            new SpellBookEntry( EvilOmenSpell.Info.Circle,      EvilOmenSpell.Info.skillForCasting, "Présage maléf.", EvilOmenSpell.Info.Reagents, 0x5004, EvilOmenSpell.m_SpellID),
            new SpellBookEntry( PainSpikeSpell.Info.Circle,     PainSpikeSpell.Info.skillForCasting, "Douleur", PainSpikeSpell.Info.Reagents, 0x5008, PainSpikeSpell.m_SpellID),
            new SpellBookEntry( StrangleSpell.Info.Circle,      StrangleSpell.Info.skillForCasting, "Étranglement", StrangleSpell.Info.Reagents, 0x500A, StrangleSpell.m_SpellID),
            ...
            //Providence
            new SpellBookEntry( StrengthSpell.Info.Circle,      StrengthSpell.Info.skillForCasting, "Force", StrengthSpell.Info.Reagents, 0x8CF, StrengthSpell.m_SpellID),
            new SpellBookEntry( AgilitySpell.Info.Circle,       AgilitySpell.Info.skillForCasting, "Agilité", AgilitySpell.Info.Reagents, 0x8C8, AgilitySpell.m_SpellID),
            new SpellBookEntry( CunningSpell.Info.Circle,       CunningSpell.Info.skillForCasting, "Astuce", CunningSpell.Info.Reagents, 0x8D9, CunningSpell.m_SpellID),
            new SpellBookEntry( PeauDePierreSpell.Info.Circle,    PeauDePierreSpell.Info.skillForCasting, "Peau de Pierre", PeauDePierreSpell.Info.Reagents, 0x5CC, PeauDePierreSpell.m_SpellID),
            new SpellBookEntry( ChampEntropiqueSpell.Info.Circle, ChampEntropiqueSpell.Info.skillForCasting, "Champ Entropique", ChampEntropiqueSpell.Info.Reagents, 0x5D6, ChampEntropiqueSpell.m_SpellID),
            new SpellBookEntry( SacrificeSpell.Info.Circle,         SacrificeSpell.Info.skillForCasting, "Sacrifice", SacrificeSpell.Info.Reagents, 0x8CE, SacrificeSpell.m_SpellID),
            new SpellBookEntry( BlessSpell.Info.Circle,         BlessSpell.Info.skillForCasting, "Bénédiction", BlessSpell.Info.Reagents, 0x8D0, BlessSpell.m_SpellID),
            new SpellBookEntry( ReactiveArmorSpell.Info.Circle, ReactiveArmorSpell.Info.skillForCasting, "Armure de mage", ReactiveArmorSpell.Info.Reagents, 0x8C6, ReactiveArmorSpell.m_SpellID),
            new SpellBookEntry( MagicReflectSpell.Info.Circle,  MagicReflectSpell.Info.skillForCasting, "Reflection", MagicReflectSpell.Info.Reagents, 0x8E3, MagicReflectSpell.m_SpellID),
            ...
            //Thaumaturgie
            new SpellBookEntry( HealSpell.Info.Circle,          HealSpell.Info.skillForCasting, "Soins", HealSpell.Info.Reagents, 0x8C3, HealSpell.m_SpellID),
            new SpellBookEntry( CureSpell.Info.Circle,          CureSpell.Info.skillForCasting, "Antidote", CureSpell.Info.Reagents, 0x8DA, CureSpell.m_SpellID),
            new SpellBookEntry( GreaterHealSpell.Info.Circle,   GreaterHealSpell.Info.skillForCasting, "Soins majeurs", GreaterHealSpell.Info.Reagents, 0x8DC, GreaterHealSpell.m_SpellID),
            new SpellBookEntry( TotemRegenSpell.Info.Circle,    TotemRegenSpell.Info.skillForCasting, "Totem de guérison", TotemRegenSpell.Info.Reagents, 0x5B6, TotemRegenSpell.m_SpellID),
            new SpellBookEntry( DernierSouffleSpell.Info.Circle, DernierSouffleSpell.Info.skillForCasting, "Dernier souffle", DernierSouffleSpell.Info.Reagents, 0x8F7, DernierSouffleSpell.m_SpellID),
            new SpellBookEntry( AdrenalineSpell.Info.Circle, AdrenalineSpell.Info.skillForCasting, "Adrénaline", AdrenalineSpell.Info.Reagents, 0x5B4, AdrenalineSpell.m_SpellID),
            ...
            //Ensorcellement
            new SpellBookEntry( WeakenSpell.Info.Circle,        WeakenSpell.Info.skillForCasting, "Faiblesse", WeakenSpell.Info.Reagents, 0x8C7, WeakenSpell.m_SpellID),
            new SpellBookEntry( ClumsySpell.Info.Circle,        ClumsySpell.Info.skillForCasting, "Maladresse", ClumsySpell.Info.Reagents, 0x8C0, ClumsySpell.m_SpellID),
            new SpellBookEntry( FeeblemindSpell.Info.Circle,    FeeblemindSpell.Info.skillForCasting, "Abrutissement", FeeblemindSpell.Info.Reagents, 0x8C2, FeeblemindSpell.m_SpellID),
            new SpellBookEntry( HarmSpell.Info.Circle,          HarmSpell.Info.skillForCasting, "Blessure", HarmSpell.Info.Reagents, 0x8CB, HarmSpell.m_SpellID),
            new SpellBookEntry( ManaDrainSpell.Info.Circle,     ManaDrainSpell.Info.skillForCasting, "Drain de mana", ManaDrainSpell.Info.Reagents, 0x8DE, ManaDrainSpell.m_SpellID),
            new SpellBookEntry( CurseSpell.Info.Circle,         CurseSpell.Info.skillForCasting, "Malédiction", CurseSpell.Info.Reagents, 0x8DA, CurseSpell.m_SpellID),
            new SpellBookEntry( AffaiblissementSpell.Info.Circle, AffaiblissementSpell.Info.skillForCasting, "Affaiblissement", AffaiblissementSpell.Info.Reagents, 0x5B7, AffaiblissementSpell.m_SpellID),
            new SpellBookEntry( ManaVampireSpell.Info.Circle,   ManaVampireSpell.Info.skillForCasting, "Drain vampiriq.", ManaVampireSpell.Info.Reagents, 0x8F4, ManaVampireSpell.m_SpellID),
