...
namespace Server.Gumps
{
	...
	public class PlayerVendorOwnerGump : Gump
	{
		...
		public PlayerVendorOwnerGump( PlayerVendor vendor ) : base( 50, 200 )
		{
            ...
            AddBackground(21, 3, 538, 192, 2620);
			...
			if ( goldHeld < perRealWorldDay )
			{
                ...
                //AddLabel(40, 35, 0x1F, "Salaire Journalier du NPC:");
                //AddLabel( 300, 35, 0x1F, goldNeeded.ToString() );
                AddHtml(40, 35, 200, 20, "<h3><basefont color=#FFFFFF>Salaire Journalier du NPC:<basefont></h3>", false, false);
                AddHtml(300, 35, 200, 20, "<h3><basefont color=#FFFFFF>" + goldNeeded.ToString()+ "<basefont></h3>", false, false);
			}
			else
			{
            ...
            //AddLabel(40, 58, 0x480, "Ma charge pour chaque jour (IRL) est:");
			//AddLabel( 300, 58, 0x480, perRealWorldDay.ToString() );
            AddHtml(40, 58, 200, 20, "<h3><basefont color=#FFFFFF>Ma charge pour chaque jour (IRL) est:<basefont></h3>", false, false);
            ...
            AddHtml(408, 21, 200, 20, "<h3><basefont color=#FFFFFF>Voir l'inventaire<basefont></h3>", false, false);
            //AddLabel(408, 21, 0x480, "Voir l'inventaire");
            ...
            AddHtml(408, 41, 200, 20, "<h3><basefont color=#FFFFFF>Personnaliser<basefont></h3>", false, false);
            //AddLabel(408, 41, 0x480, "Personnaliser");
            ...
            AddHtml(408, 81, 200, 20, "<h3><basefont color=#FFFFFF>Nommer le vendeur<basefont></h3>", false, false);
            //AddLabel(408, 81, 0x480, "Renommer le vendeur");
            ...
            AddHtml(408, 101, 200, 20, "<h3><basefont color=#FFFFFF>Ourir le paperdoll<basefont></h3>", false, false);
            //AddLabel(408, 101, 0x480, "Ourir le paperdoll");
            ...
            AddHtml(408, 121, 200, 20, "<h3><basefont color=#FFFFFF>Collecter l'or<basefont></h3>", false, false);
			//AddLabel( 408, 121, 0x480, "Collecter l'or" );

			AddButton( 390, 144, 0x15E1, 0x15E5, 7, GumpButtonType.Reply, 0 );
            AddHtml(408, 141, 200, 20, "<h3><basefont color=#FFFFFF>Termination<basefont></h3>", false, false);
			//AddLabel( 408, 141, 0x480, "Renvoyer le vendeur" );

			AddButton( 390, 162, 0x15E1, 0x15E5, 0, GumpButtonType.Reply, 0 );
            AddHtml(408, 161, 200, 20, "<h3><basefont color=#FFFFFF>Annuler<basefont></h3>", false, false);
            //AddLabel(408, 161, 0x480, "Annuler");
	...
	public class PlayerVendorCustomizeGump : Gump
	{
		...
		private static CustomCategory[] Categories = new CustomCategory[]{
			...
			new CustomCategory( Layer.FirstValid, 1011397, false, new CustomItem[]{//Held items
				...
				new CustomItem( typeof( Batonvoyage ), 1011413, 5113 )
			} ),
