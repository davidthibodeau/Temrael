	...
	public class Docs
	{
		...
		private static void DocumentBulkOrders()
		{
			using( StreamWriter html = GetWriter( "docs/bods/", "bod_smith_rewards.html" ) )
			{
				...
				sbod.RequireExceptional = false;
				for( BulkMaterialType mat = BulkMaterialType.None; mat <= BulkMaterialType.Umbrarium; ++mat )
				{
					sbod.Material = mat;
					sbod.AmountMax = 10;
			...
			using( StreamWriter html = GetWriter( "docs/bods/", "bod_tailor_rewards.html" ) )
			{
				...
				{
					if( mat >= BulkMaterialType.Cuivre && mat <= BulkMaterialType.Umbrarium )
						continue;
		...
		private static void DocumentSmithBOD( StreamWriter html, List<Item> items, string amt, BulkMaterialType material )
		{
			...
			switch( material )
			{
				case BulkMaterialType.None: style = "fr"; name = "Fer"; break;
				case BulkMaterialType.Cuivre: style = "cu"; name = "Cuivre"; break;
				case BulkMaterialType.Bronze: style = "br"; name = "Bronze"; break;
				case BulkMaterialType.Acier: style = "ac"; name = "Acier"; break;
				case BulkMaterialType.Argent: style = "ar"; name = "Argent"; break;
				case BulkMaterialType.Or: style = "or"; name = "Or"; break;
				case BulkMaterialType.Mytheril: style = "my"; name = "Mytheril"; break;
				case BulkMaterialType.Luminium: style = "lu"; name = "Luminium"; break;
				case BulkMaterialType.Obscurium: style = "ob"; name = "Obscurium"; break;
                case BulkMaterialType.Mystirium: style = "ms"; name = "Mystirium"; break;
                case BulkMaterialType.Dominium: style = "do"; name = "Dominium"; break;
                case BulkMaterialType.Eclarium: style = "ec"; name = "Eclarium"; break;
                case BulkMaterialType.Venarium: style = "ve"; name = "Venarium"; break;
                case BulkMaterialType.Athenium: style = "at"; name = "Athenium"; break;
                case BulkMaterialType.Umbrarium: style = "um"; name = "Umbrarium"; break;
			}
