...
namespace Server.Scripts.Commands
{
	public class ToolbarHelper
	{
		...
		public static void EnsureMaxed( Mobile mob )
		{
			...
			{
				((Account)mob.Account).AccessLevel = mob.AccessLevel;
		...
		public static List<string> DefaultEntries( int i )
		{
			...
			switch(i)
			{
				case 0: // Player
					break;
				case 1: // Counselor
					entries.Add(".Who"); entries.Add(".Where"); entries.Add(".Tele"); entries.Add(".M Tele");
					break;
				case 2: // GameMaster
					entries.Add(".Who"); entries.Add(".Where"); entries.Add(".Tele"); entries.Add(".M Tele"); for( int j = 0; j < 4; j++ ){entries.Add("-*UNUSED*-");}
					entries.Add(".Add"); entries.Add(".Move"); entries.Add(".Delete"); entries.Add(".Wipe"); entries.Add(".Kill");
					break;
				case 3: // Seer
					goto case 2;
				case 4: // Administrator
					entries.Add(".Admin"); entries.Add(".Where"); entries.Add(".Tele"); entries.Add(".M Tele");  for( int j = 0; j < 4; j++ ){entries.Add("-*UNUSED*-");}
					entries.Add(".Add"); entries.Add(".Move"); entries.Add(".Delete"); entries.Add(".Kill");
					break;
				case 5: // Developer
					goto case 4;
				case 6: // Owner
		...
		public static List<int> DefaultDimensions( int i )
		{
			...
			switch(i)
			{
				case 0: // Player
					...
					break;
				case 1: // Counselor
					dimensions.Add(5); dimensions.Add(1);
					break;
				case 2: // GameMaster
					dimensions.Add(5); dimensions.Add(2);
					break;
				case 3: // Seer
					goto case 2;
				case 4: // Administrator
	...
	// Version 1.0
		...
		public override void OnResponse(NetState sender, RelayInfo info)
		{
			...
			switch(info.ButtonID)
			{
				default:	// Command
					mob.SendGump(this);
                    if (Commands[info.ButtonID - 10].StartsWith("."))
					{
