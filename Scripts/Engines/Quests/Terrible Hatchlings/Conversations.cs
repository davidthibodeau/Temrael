...
namespace Server.Engines.Quests.Zento
{
	...
	public class DirectionConversation : QuestConversation
	{
		public override object Message
		{
			get
			{
				// The Deathwatch Scarabee Hatchlings live in The Waste - the desert close to this city.
				return 1063323;
			}
		}
	...
	public class TakeCareConversation : QuestConversation
	{
		public override object Message
		{
			get
			{
				// I know you can take care of those nasty Deathwatch Scarabee Hatchlings! No get to it!
				return 1063324;
			}
		}
