...
namespace Server.Engines.Harvest
{
	public class Lumberjacking : HarvestSystem
	{
        ...
        private Lumberjacking()
        {
            ...
            lumber.Skill = SkillName.Foresterie;
        ...
        public static int[] m_CedreTiles = new int[]
			{
                0x4CD0, 0x4CD3, 
        ...
        public static int[] m_CypresTiles = new int[]
			{
        ...
        public static int[] m_EbeneTiles = new int[]
			{
                0x4CCA, 0x4CCB, 0x4CCC, 0x31CA
            };

        public static int[] m_ErableTiles = new int[]
			{
                0x4CCD, 0x4CDA, 0x4CDD, 
                
                0x71C4, 0x575C
            };

        public static int[] m_AcajouTiles = new int[]
			{
                0x4CE0, 0x4CE3, 
        ...
        public static int[] m_SauleTiles = new int[]
			{
                0x4CE6, 
