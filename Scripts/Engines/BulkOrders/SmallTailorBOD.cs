...
namespace Server.Engines.BulkOrders
{
	public class SmallTailorBOD : SmallBOD
	{
		...
		public static SmallTailorBOD CreateRandomFor( Mobile m )
		{
			...
			double theirSkill = m.Skills[SkillName.Couture].Base;
				...
				if ( useMaterials && theirSkill >= 70.1 )
				{
					for ( int i = 0; i < 20; ++i )
					{
						...
						switch ( check )
						{
							...
							case BulkMaterialType.Acier: skillReq = 90.0; break;
							case BulkMaterialType.Argent: skillReq = 95.0; break;
							case BulkMaterialType.Mytheril: skillReq = 100.0; break;
