...
namespace Server.Engines.BulkOrders
{
	...
	public class SmallSmithBOD : SmallBOD
	{
		...
		public static SmallSmithBOD CreateRandomFor( Mobile m )
		{
			...
			if ( entries.Length > 0 )
			{
				double theirSkill = m.Skills[SkillName.Forge].Base;
				int amountMax;
				...
				if ( useMaterials && theirSkill >= 70.1 )
				{
					for ( int i = 0; i < 20; ++i )
					{
						BulkMaterialType check = GetRandomMaterial( BulkMaterialType.Cuivre, m_BlacksmithMaterialChances );
						double skillReq = 0.0;

						switch ( check )
						{
							case BulkMaterialType.Cuivre: skillReq = 65.0; break;
							case BulkMaterialType.Bronze: skillReq = 70.0; break;
							case BulkMaterialType.Acier: skillReq = 75.0; break;
							case BulkMaterialType.Argent: skillReq = 80.0; break;
							case BulkMaterialType.Or: skillReq = 85.0; break;
							case BulkMaterialType.Mytheril: skillReq = 90.0; break;
		...
		public SmallSmithBOD()
		{
			...
			if ( entries.Length > 0 )
			{
				...
				if ( useMaterials )
					material = GetRandomMaterial( BulkMaterialType.Cuivre, m_BlacksmithMaterialChances );
				else
