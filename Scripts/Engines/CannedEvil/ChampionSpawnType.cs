		...
		private static readonly ChampionSpawnInfo[] m_Table = new ChampionSpawnInfo[]
			{
				...
				{																											// Forest Lord
					...
					new Type[]{ typeof( Centaur ), typeof( Licorne ) },														// Level 3
				...
				{																											// Unholy Terror
					new Type[]{ typeof( DeathwatchScarabeeHatchling ), typeof( Lizardman ) },
					new Type[]{ typeof( DeathwatchScarabee ), typeof( Kappa ) },
					new Type[]{ typeof( RevenantLion ) },
					new Type[]{ typeof( Griffon ), typeof( Oni ) }
				} ),
