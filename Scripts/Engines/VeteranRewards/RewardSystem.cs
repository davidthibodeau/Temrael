			...
			m_Lists = new RewardList[]
				{
					...
					new RewardList( RewardInterval, 4, new RewardEntry[]
					{
						...
						new RewardEntry( etherealSteeds, 1049745, typeof( EtherealLicorne ) ),
					...
					new RewardList( RewardInterval, 5, new RewardEntry[]
					{
						...
						new RewardEntry( etherealSteeds, 1049749, typeof( EtherealDragonMarais ) ),
						new RewardEntry( etherealSteeds, 1049748, typeof( EtherealScarabee ) ),
