...
namespace Server.Mobiles
{
	...
	public class YomotsuPriest : BaseCreature
	{
		...
		public YomotsuPriest() : base( AIType.AI_Mage, FightMode.Closest, 10, 1, 0.2, 0.4 )
		{
			...
			SetResistance( ResistanceType.Tranchant, 45, 65 );
			SetResistance( ResistanceType.Perforant, 35, 55 );
			SetResistance( ResistanceType.Magie, 25, 50 );

			//SetSkill( SkillName.EvalInt, 92.6, 107.5 );
			SetSkill( SkillName.ArtMagique, 105.1, 115.0 );
			SetSkill( SkillName.Concentration, 100.1, 110.0 );
			SetSkill( SkillName.Concentration, 112.6, 122.5 );
			SetSkill( SkillName.Tactiques, 55.1, 105.0 );
			SetSkill( SkillName.ArmePoing, 47.6, 57.5 );
