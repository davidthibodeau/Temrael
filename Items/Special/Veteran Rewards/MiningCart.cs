				...
				switch ( m_CartType )
				{
					...
					case MiningCartType.OreEast:
						if ( m_Ore > 0 )
						{
							...
							{
								case 0: ingots = new FerIngot(); break;
								case 1: ingots = new CuivreIngot(); break;
								case 2: ingots = new BronzeIngot(); break;
								case 3: ingots = new AcierIngot(); break;
								case 4: ingots = new ArgentIngot(); break;
								case 5: ingots = new OrIngot(); break;
								case 6: ingots = new MytherilIngot(); break;
							}
