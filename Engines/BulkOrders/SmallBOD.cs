...
namespace Server.Engines.BulkOrders
{
	...
	public abstract class SmallBOD : Item
	{
		...
		public static BulkMaterialType GetMaterial( CraftResource resource )
		{
			switch ( resource )
			{
				case CraftResource.Cuivre:  		return BulkMaterialType.Cuivre;
				case CraftResource.Bronze:  		return BulkMaterialType.Bronze;
				case CraftResource.Acier:			return BulkMaterialType.Acier;
				case CraftResource.Argent:			return BulkMaterialType.Argent;
				case CraftResource.Or:  			return BulkMaterialType.Or;
				case CraftResource.Mytheril:		return BulkMaterialType.Mytheril;
				case CraftResource.Luminium:		return BulkMaterialType.Luminium;
				case CraftResource.Obscurium:		return BulkMaterialType.Obscurium;
			}
