		...
		private static MerchantTitleInfo[] m_Info = new MerchantTitleInfo[]
			{
				...
				new MerchantTitleInfo( SkillName.Bricolage,		90.0,	new TextDefinition( 1022984, "Tinker" ),		new TextDefinition( 1011470, "TINKER" ),		new TextDefinition( 1010123, "You now have the faction title of tinker" ) ),
