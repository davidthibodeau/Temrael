        ...
        private static SkillInfo[] m_Table = new SkillInfo[]
			{
                ...
                new SkillInfo( SkillName.Alchimie,		  "Alchimie",		SkillCategory.Artisanat,	0.0,	5.0,	5.0,	null,	0.0,	0.5,	1.5,	1.0 ),
				new SkillInfo( SkillName.Fignolage, 	  "Fignolage",  	SkillCategory.Artisanat,    0.0,	0.0,	0.0,	null,	0.0,	1.0,	1.0,	1.0 ),
				new SkillInfo( SkillName.Forge,           "Forge",      	SkillCategory.Artisanat,	10.0,	0.0,	0.0,	null,	1.5,	0.5,	0.0,	1.0 ),
                
				new SkillInfo( SkillName.Menuiserie,      "Menuiserie",		SkillCategory.Artisanat,	20.0,	5.0,	0.0,	null,	1.0,	1.0,	0.0,	1.0 ),
				new SkillInfo( SkillName.Cuisine,         "Cuisine",		SkillCategory.Artisanat,	0.0,	20.0,	30.0,	null,	0.0,	1.5,	0.5,	1.0 ),
				new SkillInfo( SkillName.Couture,         "Couture",		SkillCategory.Artisanat,	3.75,	16.25,	5.0,	null,	0.0,	2.0,	0.0,	1.0 ),
				new SkillInfo( SkillName.Excavation,      "Excavation",		SkillCategory.Artisanat,	20.0,	0.0,	0.0,	null,	2.0,	0.0,	0.0,	1.0 ),
                new SkillInfo( SkillName.Polissage,       "Polissage",		SkillCategory.Artisanat,	0.0,	0.0,	0.0,	null,	0.0,	0.5,	1.5,	1.0 ),

                new SkillInfo( SkillName.ArmeHaste,		  "Arme d'Haste",		SkillCategory.Combat,	0.0,	0.0,	0.0,	null,	1.8,	0.2,	0.0,	1.0 ),
				new SkillInfo( SkillName.Parer, 		  "Parer",				SkillCategory.Combat,	7.5,	2.5,	0.0,	null,	0.0,	1.6,	0.4,	1.0 ),
                new SkillInfo( SkillName.Equitation,      "Equitation",			SkillCategory.Combat, 	6.0,	16.0,	0.0,	null,	0.5,	1.0,	0.5,	1.0 ),
				new SkillInfo( SkillName.Soins,           "Soins",				SkillCategory.Combat,	6.0,	6.0,	8.0,	null,	0.0,	0.7,	1.3,	1.0 ),
				new SkillInfo( SkillName.Tactiques,       "Tactiques",			SkillCategory.Combat,  	0.0,	0.0,	0.0,	null,	1.0,	0.8,	0.2,	1.0 ),
				new SkillInfo( SkillName.ArmeDistance,    "Arme de Distance",	SkillCategory.Combat,  	2.5,	7.5,	0.0,	null,	0.75,	1.25,	0.0,	1.0 ),
				new SkillInfo( SkillName.Epee,  		  "Epee",  				SkillCategory.Combat,	7.5,	2.5,	0.0,	null,	1.5,	0.5,	0.0,	1.0 ),
                new SkillInfo( SkillName.Hache,      	  "Hache",     			SkillCategory.Combat,	10.0,	0.0,	0.0,	null,	1.9,	0.1,	0.0,	1.0 ),
                ...
                new SkillInfo( SkillName.ArtMagique,        "Art de la Magie",  SkillCategory.Magie,    0.0,    0.0,    15.0,   null,   0.0,    0.5,	1.5,	1.0 ),
                new SkillInfo( SkillName.Evocation,         "Evocation",        SkillCategory.Magie,    0.0,    0.0,    15.0,   null,   0.0,    0.0,	2.0,	1.0 ),
                new SkillInfo( SkillName.Immuabilite,       "Immuabilite",      SkillCategory.Magie,    0.0,    0.0,    15.0,   null,   0.0,    0.0,	2.0,	1.0 ),
                new SkillInfo( SkillName.Alteration,        "Alteration",       SkillCategory.Magie,    0.0,    0.0,    15.0,   null,   0.5,    0.0,	1.5,	1.0 ),
                new SkillInfo( SkillName.Providence,        "Providence",       SkillCategory.Magie,    0.0,    0.0,    15.0,   null,   0.0,    0.0,	2.0,	1.0 ),
                new SkillInfo( SkillName.Transmutation,     "Transmutation",    SkillCategory.Magie,    0.0,    0.0,    15.0,   null,   0.0,    0.0,	2.0,	1.0 ),
                new SkillInfo( SkillName.Thaumaturgie,      "Thaumaturgie",     SkillCategory.Magie,    0.0,    0.0,    15.0,   null,   0.0,    0.0,	2.0,	1.0 ),
                ...
                new SkillInfo( SkillName.Survie,          "Survie",	  			SkillCategory.Roublardise,	20.0,	15.0,	15.0, 	null,	0.5,	0.5,	1.0,	1.0 ),
				new SkillInfo( SkillName.Detection,       "Detection",			SkillCategory.Roublardise,	0.0,	0.0,	0.0,	null,	0.0,	0.8,	1.2,	1.0 ),
				new SkillInfo( SkillName.Discretion,      "Discretion",			SkillCategory.Roublardise,	0.0,	0.0,	0.0, 	null,	0.0,	1.6,	0.4,	1.0 ),
				new SkillInfo( SkillName.Crochetage,      "Crochetage",			SkillCategory.Roublardise,	0.0,	25.0,	0.0,	null,	0.0,	2.0,	0.0,	1.0 ),
				new SkillInfo( SkillName.Fouille,         "Fouille",			SkillCategory.Roublardise,	0.0,	25.0,	0.0,	null,	0.0,	2.0,	0.0,	1.0 ),
				new SkillInfo( SkillName.Empoisonnement,  "Empoisonnement",		SkillCategory.Roublardise,	0.0,	4.0,	16.0,	null,	0.0,	0.4,	1.6,	1.0 ),
				new SkillInfo( SkillName.Vol,             "Vol",				SkillCategory.Roublardise,	0.0,	10.0,	0.0,	null,	0.0,	2.0,	0.0,	1.0 ),
